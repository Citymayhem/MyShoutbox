...
INSERT INTO `{MYBB_TABLE_PREFIX}mysb_shouts` VALUES (NULL, 1, 'Test Shout! Without any shout, shoutbox will display Loading... forever.. you need at least one shout, so here it is.', UNIX_TIMESTAMP(), '127.0.0.1', 'no');
